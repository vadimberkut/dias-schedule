...
namespace ScheduleApp.Areas.Admin.Controllers
{
    public class TeacherController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="Id,FirstName,LastName,MiddleName,Gender,DateOfBirth")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="Id,FirstName,LastName,MiddleName,Gender,DateOfBirth")] Teacher teacher)
        {
            if (ModelState.IsValid)
            {
